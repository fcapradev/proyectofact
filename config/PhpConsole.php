...
/////////////////////////////////////////////////////////////////////////////
///////////////////		FRANCO CONSOLA PHP ERRORES		/////////////////////
/////////////////////////////////////////////////////////////////////////////

		if(basename(getcwd()) == 'ultimo'){
			$f = fopen('Log/ErrorConsola.log','a+');			
		}else{
			$f = fopen('../Log/ErrorConsola.log','a+');
		}
	
		fwrite($f,"".date('Y-m-d H:i:s')." | ".$message['type']." | ".$message['subject']." | ".$message['text']." | ".@$message['source']." \r\n");
		fclose($f);	
