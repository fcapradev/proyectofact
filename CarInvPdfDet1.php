...
$pdf->SetHeaderData('debo.jpg', 50, 'Carga de Inventario '.date('Y-m-d H:i'), 'Empresa Nº: '.$numEmp.'. Detallado Por Precio de Costo');
...
//** ITEMS A MOSTRAR
$_SESSION['ParSQL'] = "SELECT *,round(PRE,4,1) PRE,round(COS,4,1) COS,round(CAR,4,1) CAR,round(AJU,4,1) AJU,round(REA,4,1) REA,round(DIF,4,1) DIF,round(CON,4,1) CON FROM ITOMINVD WHERE INV = $num_inv ORDER BY INV DESC"; 
$R1TB = mssql_query($_SESSION['ParSQL']) or die("Error SQL");
rollback($R1TB);
$c=0;
$total = 0;
...
$lista = '<table border="0" width="955" cellpadding="0" cellspacing="0">
			<tr bordercolor="#999999" bgcolor="#999999">
				...
				<td width="65" align="center">Costo Unitario</td>
...
$lista ='<table border="0" width="955" cellpadding="-10" cellspacing="0">
			<tr>
				...
				<td width="65" align="right">'.dec($ATU['COS'],2).'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
				<td width="65" align="right">'.$DF.'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
...
<br>
	<table width="995" border="0">
		...
		<tr>
			<td width="730" >&nbsp;</td>
			<td colspan="2" align="center" border="1" bordercolor="#666666">&nbsp;'.$total.'</td>
...
$p = "Pdf/CargaInventario/Car_Inv_Cos_".$numEmp.".pdf";
$pdf->Output($p, 'F');
