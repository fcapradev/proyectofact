...
$pdf->SetHeaderData('debo.jpg', 50, 'Carga de Inventario '.date('Y-m-d H:i'), 'Empresa Nº: '.$numEmp.'');
...
while ($ATU=mssql_fetch_array($R1TB)){
	$ATU['SEC']=format($ATU['SEC'],2,'0',STR_PAD_LEFT);
	$ATU['ART']=format($ATU['ART'],4,'0',STR_PAD_LEFT);
	...
	if($c == 1){
		...
		<table width="640" border="0" cellpadding="0" cellspacing="0">
			<tr bordercolor="#999999" bgcolor="#999999">
				...
				<td  width="55" align="center">Stock a la Toma</td>
				<td  width="55" align="center">Stock Inventario (contado)</td>
				<td  width="55" align="center">Stock a la Carga</td>
				<td  width="55" align="center">Ajuste de Stock</td>
				<td  width="55" align="center">Stock Real</td>
				<td  width="55" align="center">Diferencia de Stock</td>
			</tr>
	...
	<tr>
		<td  width="55" align="center">'.$ATU['SEC'].'-'.$ATU['ART'].'&nbsp;&nbsp;&nbsp;&nbsp;</td>
		<td  width="245" align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'.$ATU['DET'].'</td>
		<td  width="55" align="right">'.dec($ATU['TOM'],2).'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
		<td  width="55" align="right">'.dec($ATU['CON'],2).'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
		<td  width="55" align="right">'.dec($ATU['CAR'],2).'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
		<td  width="55" align="right">'.dec($ATU['AJU'],2).'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
		<td  width="55" align="right">'.dec($ATU['REA'],2).'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
		<td  width="55" align="right">'.dec($ATU['DIF'],2).'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
	</tr>
	</table>
	';
$pdf->writeHTML($titulo, true, false, false, false, '');
...
$p = "Pdf/CargaInventario/Car_Inv_Res_".$numEmp.".pdf";
$pdf->Output($p, 'F');
