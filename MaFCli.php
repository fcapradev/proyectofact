...
function cuit_eve2_vol(){
	...
	document.getElementById('NumVol').innerHTML = '<button class="StyBoton" onclick="direc_eve_vol();" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage(\'NumVol21\',\'\',\'botones/vol-over.png\',0)"><img src="botones/vol-up.png" name="Enter" title="Enter" border="0" id="NumVol21"/></button>';
...
function enviar_eve(){
	...
	if(re != 3){
		...
		if(co == true){
			...
			document.getElementById('NumVol').innerHTML = '<button class="StyBoton" onclick="cuit_eve2_vol();" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage(\'NumVol21\',\'\',\'botones/vol-over.png\',0)"><img src="botones/vol-up.png" name="Enter" title="Enter" border="0" id="NumVol21"/></button>';
...
function nombre_eve_vol(){
	...
	document.getElementById('NumVol').innerHTML = '<button class="StyBoton" onclick="nombre_eve();" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage(\'NumVol21\',\'\',\'botones/ent-over.png\',0)"><img src="botones/ent-up.png" name="Enter" title="Enter" border="0" id="NumVol21"/></button>';
...
function nombre_eve(){
	...
	if(c != 0){
		...
		document.getElementById('NumVol').innerHTML = '<button class="StyBoton" onclick="nombre_eve_vol();" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage(\'NumVol21\',\'\',\'botones/vol-over.png\',0)"><img src="botones/vol-up.png" name="Enter" title="Enter" border="0" id="NumVol21"/></button>';
...
function respon(){
	...
	document.getElementById('LetTer').innerHTML = '<button class="StyBoton" onclick="enviar_eve();" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage(\'LetTer2minarEve\',\'\',\'botones/ter-over.png\',0)"><img src="botones/ter-up.png" name="Terminar" title="Terminar" border="0" id="LetTer2minarEve"/></button>';
...
<td>
    ...
    <div style="position:absolute; left:117px; top:40px;">
        ...
        <div style="position:absolute; width:210px; height:17px; left:13px; top:155px;">
            <input type="hidden" id="responevef" name="responevef" value="0" />
            <input type="text" id="responevef_tx" name="responevef_tx" style="width:209px; border:0;" onclick="MostrarCombo();" />            
        </div>
