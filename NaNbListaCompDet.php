...
$r_cod = $_REQUEST['cod'];
	...
	$_SESSION['ParSQL'] = "SELECT NOM, COD FROM PROVEED where COD = ".$r_cod."";
	...
	$total = $PMOV_R = mssql_num_rows($PMOVFACT);
	$_SESSION['Articulos_Total'] = $total;
	...
	?>
	<div class="ItemLis2" id="Art<? echo $cc; ?>">
		<table width="474" border="0" cellpadding="0" cellspacing="1">
		<tr>
			<td width="50" ><div id="cod<? echo $cc; ?>" align="center"><? echo $FAC; ?></div></td>
			<td width="87" ><div id="can<? echo $cc; ?>" align="center"><? echo $CAN; ?></div></td>
			<td width="172"><div id="detart<? echo $cc; ?>" align="left"  ><? echo $TIO; ?></div></td>
			<td width="84" ><div id="pre<? echo $cc; ?>" align="center"><? echo $PUN; ?></div></td>
  			<td width="84" ><div id="imp<? echo $cc; ?>" align="center"><? echo $SUB; ?></div></td>
            <?
...
$TIT1 = "Proveedor: ".format($COD,4,'0',STR_PAD_LEFT)." - ".trim($NOM)."";
...
mssql_query("commit transaction") or die("Error SQL commit");
	...
	?>
	<script>
		document.getElementById('cantidad_art').innerHTML = "<? echo $total; ?>";
	
		document.getElementById('tit1').innerHTML = "<? echo $TIT1; ?>";
		document.getElementById('tit4').innerHTML = "<? echo $COD; ?>";
		document.getElementById('tit3').innerHTML = "<? echo trim($NOM); ?>";
